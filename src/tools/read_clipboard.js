...
export const description = 'Reads text directly from the system clipboard. Also use this if the user is asking about some text but hasn\'t provided any. This function has no additional arguments'
